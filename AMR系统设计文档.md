...
用于快速了解当前专案和地图的整体运行状态。

主要内容：

- AMR总数、在线数、执行中、等待、充电和故障数量。
- 待调度、执行中、等待、异常和已完成任务数量。
- 机台设备在线状态和请求状态。
- 当前告警和严重告警数量。
- 常用快捷入口，如创建任务、编辑当前地图、打开API测试。

#### 7.1.2 数字孪生

用于按照全局楼层和地图展示AMR、任务路线、机台设备和交通状态。当前原型阶段可以保留为能力说明页，后续与交通态势地图能力协同设计。

#### 7.1.3 告警中心

集中展示和处理AMR、设备、任务、交通、地图及平台告警。
